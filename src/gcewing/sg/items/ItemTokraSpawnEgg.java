...
public class ItemTokraSpawnEgg extends Item {
	...
	public static Entity spawnCreature(World par0World, double par2, double par4, double par6) {
		EntityVillager entity = new EntityVillager(par0World, SGCraft.getProxy().getVillagerID("tokra"));
		entity.setProfession(SGCraft.getProxy().getVillagerID("tokra"));
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.itemIcon = par1IconRegister.registerIcon("spawn_egg");
		this.theIcon = par1IconRegister.registerIcon("spawn_egg_overlay");
	}
}
