...
public class LCTransportRingsStatePacket extends LCTargetPacket {

	public int type;
	public double duration;
	public Object[] args;

	public LCTransportRingsStatePacket() {
	}

	public LCTransportRingsStatePacket(DimensionPos target, int type, double duration, Object[] args) {
		this.target = target;
		this.type = type;
