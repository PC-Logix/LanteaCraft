...
public class ModelTokra extends ModelBase {
	...
	public ModelTokra(float par1) {
		this(par1, 0.0F, 64, 64);
	}

	public ModelTokra(float par1, float par2, int par3, int par4) {
		this.villagerHead = (new ModelRenderer(this)).setTextureSize(par3, par4);
		this.villagerHead.setRotationPoint(0.0F, 0.0F + par2, 0.0F);
		this.villagerHead.setTextureOffset(0, 0).addBox(-4.0F, -8.0F, -4.0F, 8, 8, 8, par1);
