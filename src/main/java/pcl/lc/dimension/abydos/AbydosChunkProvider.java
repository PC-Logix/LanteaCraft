...
import pcl.lc.dimension.MapGenFeatureStructure;
...
public class AbydosChunkProvider implements IChunkProvider {
	...
	public AbydosChunkProvider(World par1World, BiomeGenBase biomeForGeneration) {
		...
		this.structureController = new MapGenFeatureStructure();
	...
	public void replaceBlocksForBiome(int p_147422_1_, int p_147422_2_, Block[] p_147422_3_, byte[] p_147422_4_,
		...
		for (int k = 0; k < 16; ++k) {
			for (int l = 0; l < 16; ++l) {
				p_147422_5_.genTerrainBlocks(this.worldObj, this.rand, p_147422_3_, p_147422_4_, p_147422_1_ * 16 + k,
	...
	public Chunk provideChunk(int chunkX, int chunkZ) {
		...
		this.replaceBlocksForBiome(chunkX, chunkZ, ablock, abyte, this.biomeForGeneration);

		this.structureController.func_151539_a(this, this.worldObj, chunkX, chunkZ, null);

		Chunk chunk = new Chunk(this.worldObj, ablock, abyte, chunkX, chunkZ);
		byte[] abyte1 = chunk.getBiomeArray();

		for (int k = 0; k < abyte1.length; ++k)
			abyte1[k] = (byte) this.biomeForGeneration.biomeID;
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3) {
		...
		this.structureController.generateStructuresInChunk(this.worldObj, this.rand, par2, par3);
	...
	public void recreateStructures(int par1, int par2) {
		this.structureController.func_151539_a(this, this.worldObj, par1, par2, null);
	}
}