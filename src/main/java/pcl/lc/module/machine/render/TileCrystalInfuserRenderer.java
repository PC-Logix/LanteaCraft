...
public class TileCrystalInfuserRenderer extends TileEntitySpecialRenderer {
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float scale) {
		...
		if (tile.getDistanceFrom(this.field_147501_a.field_147560_j, this.field_147501_a.field_147561_k,
			...
			customitem.setEntityItemStack(new ItemStack(ModuleCore.Items.reagentItem, 1, ReagentList.CONTROLCRYSTAL
					.ordinal()));
			...
			while (q-- > 0) {
				...
				GL11.glColor4f(28.0f / 256.0f, 172.0f / 256.0f, 120.0f / 256.0f, 0.25F + (0.025f * random.nextInt(10)));
