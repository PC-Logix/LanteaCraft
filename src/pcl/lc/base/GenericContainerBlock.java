...
public abstract class GenericContainerBlock extends BlockContainer {
	...
	public void breakBlock(World world, int x, int y, int z, int par5, int par6) {
		...
		if (te instanceof IInventory) {
			...
			if (var7 != null) for (int var8 = 0; var8 < var7.getSizeInventory(); ++var8) {
				...
				if (var9 != null) {
					...
					for (float var12 = random.nextFloat() * 0.8F + 0.1F; var9.stackSize > 0; world
						...
						if (var13 > var9.stackSize) var13 = var9.stackSize;
						...
						if (var9.hasTagCompound()) var14.getEntityItem().setTagCompound(
